...
//process.exit();
     ...
     * @return Void
     */
    onReceiveAccessToken: function(body) {
        module.exports.setTokens(body);

        console.log('User has access? ' + module.exports.hasAccess());
    },

    receiveUserPermissionApproval: function(req, res) {
        var queryData       = urlLib.getQueryParams(req.url);
        var requestToken    = queryData.code;
        this.postAccessTokenRequest(req, res, requestToken, this.apiBaseUrl);
